...
order: "a0"
---
# Character: Mabel (player)

**Role:** Protagonist / player character | **First appears:** I.1
...
4. Attach `InputAction` resources for movement + interact.
5. Confirm grid-based tile movement and raycast collision work in-scene.